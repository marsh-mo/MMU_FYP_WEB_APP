...
<head>
    ...
    <script defer src="../../../js/assign_studnet_to_project.js ?v=<?php echo time();?>"></script>
            ...
            <?php if (!empty($proposals)): ?>
                <?php foreach ($proposals as $proposal): ?>
                    <div id="proposal-list" class="proposal-card">
                        ...
                        <button class="assign-btn" onclick="openAssignPopup(<?php echo $proposal['Proposal_ID']; ?>)">Assign Student</button>
